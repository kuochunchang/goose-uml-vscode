...
export interface ILogger {}
    ...
    it('should exclude node_modules by default', async () => {
      ...
      fileProvider.addFile('/node_modules/react/index.ts', 'export class Component {}');
    ...
    it('should handle abstract classes', async () => {
      ...
      expect(importIndex.resolve('BaseService')).toEqual(['/src/BaseService.ts']);
    });

    it('should handle enums', async () => {
      fileProvider.addFile('/src/Status.ts', 'export enum Status { Active, Inactive }');
  ...
  describe('language-specific filtering', () => {
    it('should exclude Python __pycache__', async () => {
      ...
      fileProvider.addFile('/src/__pycache__/app.cpython-39.pyc', 'compiled code');
