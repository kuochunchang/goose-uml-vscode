...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
    ...
    console.log('Registered parsers for:', parserService.getSupportedLanguages().join(', '));
    ...
    context.subscriptions.push(
        openUMLPanel,
        vscode.commands.registerCommand('gooseUML.generateClassDiagram', () => generateClassDiagram.execute()),
        vscode.commands.registerCommand('gooseUML.generateSequenceDiagram', () => generateSequenceDiagram.execute())
    );
